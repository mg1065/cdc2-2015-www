...
urlpatterns = patterns('',
    ...
    url(r'^accounts/admin/user/(?P<user_id>\d+)/reset$', views.admin_password_reset, name='admin_password_reset'),
    url(r'^accounts/admin/user/(?P<user_id>\d+)/delete$', views.admin_delete_user, name='admin_delete_user'),
    ...
    url(r'^accounts/admin/user/(?P<user_id>\d+)/files$', views.admin_list_user_files, name='admin_list_user_files'),
)
